...
async function csvParse() {
    const html = fs.readFileSync('./temp/content.html', 'utf-8', () => {});
    ...
    let id = 1;
    const toLeft = [];
    toLeft.push(sendNoReplyMail(undefined, 'R’21 | Final Phase Results', html.replace('<#NAME>', 'Backend'), attachment, id++));
